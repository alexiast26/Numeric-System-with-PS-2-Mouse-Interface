...
begin
	...
	-- generarea unui semnal care este filtrat ?i detecteaz? falling edge pt ps2c
	process(clk, reset)
	begin
		if reset = '1' then
			filter_reg <= (others => '0');
	...
	-- bitul de paritate impara(utilizat pentru a asigura integritatea datelor transmise prin protocolul ps2)
	par <= not (din(7) xor din(6) xor din(5) xor din(4) xor din(3) xor din(2) xor din(1) xor din(0));
	
	
	--fsm pt determinarea starii urmatoare a automatului si gestionarea caii datelor
